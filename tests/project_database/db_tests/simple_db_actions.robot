...
Test Tags           non_functioning_db_test    do_not_run
...
Example non functioning PostgreSQL database test
    [Documentation]    The following PostgreSQL database test is created for illustration purposes only! This database
    ...    test is not meant to be functional as including real database details and running real queries are beyond
    ...    the scope of this template repository.
